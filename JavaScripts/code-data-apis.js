...
`);
  ...
  add("wslide-8", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("wslide-9", "apis", "courseDetail", `
// GET {{baseUrl}}/api/course/\$id/details
// Controller: input_score_controller.dart → apiService.courseDetail()

Dart Method:
  apiService.courseDetail({
    id: String
  }) → Future&lt;CourseDetailsModel&gt;
...
`);
  ...
  add("wslide-9", "apis", "getPendingNewtTwofer", `
// GET {{baseUrl}}/api/scorecard/game/\$gameId/foursome/\$foursomeId/pending/newt-twofer/players
// Controller: input_score_controller.dart → apiService.getPendingNewtTwofer()

Dart Method:
  apiService.getPendingNewtTwofer({
    gameId: String,
    foursomeId: String,
    organizationId: String
  }) → Future&lt;AutoNewtTwoferModel&gt;
...
`);
  ...
  add("asslide-0", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-3", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-5", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-6", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-7", "apis", "courseDetail", `
// GET {{baseUrl}}/api/course/\$id/details
// Controller: input_score_controller.dart → apiService.courseDetail()
...
`);
  ...
  add("asslide-7", "apis", "getPendingNewtTwofer", `
// GET {{baseUrl}}/api/scorecard/game/\$gameId/foursome/\$foursomeId/pending/newt-twofer/players
// Controller: input_score_controller.dart → apiService.getPendingNewtTwofer()
...
`);
  ...
  add("asslide-8", "apis", "courseDetail", `
// GET {{baseUrl}}/api/course/\$id/details
// Controller: input_score_controller.dart → apiService.courseDetail()
...
`);
  ...
  add("asslide-8", "apis", "getPendingNewtTwofer", `
// GET {{baseUrl}}/api/scorecard/game/\$gameId/foursome/\$foursomeId/pending/newt-twofer/players
// Controller: input_score_controller.dart → apiService.getPendingNewtTwofer()
...
`);
  ...
  add("asslide-9", "apis", "getAcrossLeadrboard", `
// GET {{baseUrl}}/api/leaderboard/game/\$gameId/across
// Controller: leader_board_screen_controller.dart → apiService.getAcrossLeadrboard()

Dart Method:
  apiService.getAcrossLeadrboard({
    gameId: String
...
`);
  ...
  add("asslide-9", "apis", "liveLeaderboard", `
// GET {{baseUrl}}/api/leaderboard/game/\$gameId/foursome/\$foursomeId
// Controller: leader_board_screen_controller.dart → apiService.liveLeaderboard()

Dart Method:
  apiService.liveLeaderboard({
    gameId: String,
    foursomeId: String,
    organizationId: String
...
`);
  ...
  add("asslide-10", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-11", "apis", "getGameDetails", `
// GET {{baseUrl}}/api/games/\$gameId/details
// Controller: add_score_controller.dart → apiService.getGameDetails()
...
`);
  ...
  add("asslide-calcutta-1", "apis", "getCalcuttaRounds", `
// GET {{baseUrl}}/api/games/calcutta/game/\$gameId/round/players
// Controller: calcutta_round_one_bottom_sheet_controller.dart → apiService.getCalcuttaRounds()
...
`);
  ...
  add("asslide-calcutta-1", "apis", "getMemberList", `
// GET {{baseUrl}}/api/user/member/list
// Controller: calcutta_round_one_bottom_sheet_controller.dart → apiService.getMemberList()
...
`);
  ...
  add("asslide-calcutta-1", "apis", "updatBetType", `
// POST {{baseUrl}}/api/games/calcutta/team/bets
// Controller: calcutta_round_one_bottom_sheet_controller.dart → apiService.updatBetType()

Dart Method:
  apiService.updatBetType({
    gameId: String,
    playerId: String,
    betType: String
  }) → Future&lt;VegasCodModel&gt;
...
`);
  ...
  add("asslide-calcutta-2", "apis", "getMemberList", `
// GET {{baseUrl}}/api/user/member/list
// Controller: calcutta_round_select_player_bottom_sheet_controller.dart → apiService.getMemberList()
...
`);
  ...
  add("asslide-calcutta-2", "apis", "postCalcuttaRoundGame", `
// POST {{baseUrl}}/api/games/calcutta/buy/players
// Controller: calcutta_round_select_player_bottom_sheet_controller.dart → apiService.postCalcuttaRoundGame()

Dart Method:
  apiService.postCalcuttaRoundGame({
    gameId: String,
    ownerId: String,
    round: String,
    List<RoundPlayersList> roundPlayerList
  }) → Future&lt;DefaultModel&gt;
...
`);
  ...
  add("asslide-calcutta-5", "apis", "updatePlayers", `
// POST {{baseUrl}}/api/games/edit/store/calcutta-players
// Controller: calcutta_player_select_bottom_controller.dart → apiService.updatePlayers()

Dart Method:
  apiService.updatePlayers({
    gameId: String,
    List<String> playerId
  }) → Future&lt;CalcuttaUpdatePlayersModel&gt;
...
Response (CalcuttaUpdatePlayersModel):
  {
    "error":   false,
    "message": "..."
  }
`);
  ...
  add("asslide-calcutta-6", "apis", "assignCard", `
// POST {{baseUrl}}/api/games/\$gameID/cards/assign
// Controller: shuffle_cards_bottom_controller.dart → apiService.assignCard()

Dart Method:
  apiService.assignCard({
    playerId: String,
    gameID: String,
    card: String
  }) → Future&lt;DefaultModel&gt;
...
`);
  ...
  add("asslide-calcutta-6", "apis", "shuffleCards", `
// GET {{baseUrl}}/api/games/\$gameID/cards/shuffle
// Controller: shuffle_cards_bottom_controller.dart → apiService.shuffleCards()

Dart Method:
  apiService.shuffleCards({
    gameID: String?
  }) → Future&lt;ShuffleCardModel&gt;
...
`);
  ...
  add("asslide-calcutta-7", "apis", "addTeeTime", `
// POST {{baseUrl}}/api/games/generate/foursome/teetime
// Controller: Calcutta_foursome_match_config_bottom_sheet_controller.dart → apiService.addTeeTime()
...
`);
  ...
  add("asslide-calcutta-7", "apis", "generateFoursome", `
// GET {{baseUrl}}/api/games/\$gameID/generate/foursomes
// Controller: Calcutta_foursome_match_config_bottom_sheet_controller.dart → apiService.generateFoursome()

Dart Method:
  apiService.generateFoursome({
    gameID: String?
  }) → Future&lt;CalcuttaFoursomeModel&gt;
...
`);
  ...
  add("asslide-calcutta-8", "apis", "getGenerateMatches", `
// GET {{baseUrl}}/api/games/\$gameID/generate/calcutta-foursomes/matches
// Controller: calcutta_generate_match_config_bottom_controller.dart → apiService.getGenerateMatches()

Dart Method:
  apiService.getGenerateMatches({
    gameID: String?
  }) → Future&lt;CalcuttaMatchGenerateModel&gt;
...
Response (CalcuttaMatchGenerateModel):
  {
    "error":   false,
    "message": "..."
  }
`);
  ...
  add("asslide-ryder_cup-4", "apis", "getMemberList", `
// GET {{baseUrl}}/api/user/member/list
// Controller: single_player_select_bottom_controller.dart → apiService.getMemberList()
...
`);
  ...
  add("asslide-ryder_cup-8", "apis", "getFourSomePlayer", `
// GET {{baseUrl}}/api/foursome/\$foursomeId/players
// Controller: ryder_custom_match_bottom_controller.dart → apiService.getFourSomePlayer()
...
`);
  ...
  add("asslide-horse_race-1", "apis", "getHorseRoundPlayer", `
// GET {{baseUrl}}/api/games/horse-race/game/\$gameId/players
// Controller: horse_across_select_bottom_controller.dart → apiService.getHorseRoundPlayer()

Dart Method:
  apiService.getHorseRoundPlayer({
    gameId: String
  }) → Future&lt;HorseRaceRoundPlayerModel&gt;
...
Response (HorseRaceRoundPlayerModel):
  {
    "error":   false,
    "message": "..."
  }
`);
  ...
  add("asslide-horse_race-2", "apis", "getHorseRaceGroup", `
// GET {{baseUrl}}/api/games/horse-race/game/\$gameId/selected/groups
// Controller: horse_race_group_team_bottom_controller.dart → apiService.getHorseRaceGroup()

Dart Method:
  apiService.getHorseRaceGroup({
    gameId: String?
  }) → Future&lt;HorseRaceGroupModel&gt;
